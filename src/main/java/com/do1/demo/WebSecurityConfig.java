package com.do1.demo;


import com.do1.demo.security.CustomSecurityFilter;
import com.do1.demo.security.CustomUserDetailsService;

import com.do1.demo.security.LoginSuccessHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests()
                .antMatchers("/home","/","/error").permitAll()//访问：/home和根目录无需登录认证权限
